...
var Game = function () {
  ...
  _createClass(Game, [{
    ...
    value: function error() {
      ...
      try {
        for (var _iterator4 = this.qbes[Symbol.iterator](), _step4; !(_iteratorNormalCompletion4 = (_step4 = _iterator4.next()).done); _iteratorNormalCompletion4 = true) {
    ...
    key: "Cadenas",
    value: function Cadenas() {
      var Heads = [];

      for (var ix in this.cadenas) {
